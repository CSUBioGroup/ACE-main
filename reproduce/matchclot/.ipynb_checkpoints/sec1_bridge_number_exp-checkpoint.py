...
# running command
# python sec1_bridge_number_exp.py --DATASETS_PATH "/home/yanxh/gitrepo/multi-omics-matching/neurips2021_multimodal_topmethods-main/output/datasets/match_modality/" \
#                 --PRETRAIN_PATH "/home/yanxh/gitrepo/multi-omics-matching/neurips2021_multimodal_topmethods-main/output/pretrain/matchclot/cite_bridge_num_senst" \
...
if __name__ == "__main__":
    ...
    for del_size in [0.1, 0.2, 0.4, 0.8]:
        for repeat in range(3):
            ...
            input_train_mod1 = input_train_mod1_0[sel_cname, ].copy()
            input_train_mod2 = input_train_mod2_0[sel_cname, ].copy()
            input_test_mod1  = input_test_mod1_0.copy()
            input_test_mod2  = input_test_mod2_0.copy()

            # Load or fit LSI preprocessing
            path = os.path.join(par["output_pretrain"], f'DelSize={del_size}_repeat={repeat}')
            ...
            if not os.path.exists(os.path.join(trial_dump_folder, 'model.best.pth')):
                ...
                print(f'==> skip training of {del_size} and {repeat}')
            ...
            for fold in range(0, 9):
                ...
                if os.path.exists(weight_file):
                    ...
                    # Load torch datasets
                    dataset_test = ModalityMatchingDataset(
                        pd.DataFrame(gex_private), pd.DataFrame(mod2_private)
                    )
                    dataset_train = ModalityMatchingDataset(
